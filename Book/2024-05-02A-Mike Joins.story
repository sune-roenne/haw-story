...
- (Frank) "Alright, this is a fairly large domain and you can read up on all the formal stuff on your own time, so for the purpose at hand, let's abstract to the point where we conclude, that as a normal person that just doesn't want his savings to rot away on a bank account, you are faced with the choice of either:"
...
- Settlement and Reconciliation: So I mentioned that we aren't actually the ones to decide WHAT to invest in, but even with the decision being made by an outside party, we still need to make sure that the transactions execute as expected, such that if the Investment Advisor or Portfolio Manager has decided to buy 10.000 shares of some common stock, paying 102,76 EUR per share, that we actually receive the 10.000 shares in our custody, and that no more than 10.276.000 EUR is withdrawn from our bank accounts
